...
results = {}
search_category_list = ['Accommodation', 'hairdresser', 'engineering', 'restaurants'] #   # 'clothing', 'computer', 'electronic', 'gifts', 'animals', 'sports', 'toys', 'vehicle', 'religion', 'garden', 'health', 'non profit', 'books'
